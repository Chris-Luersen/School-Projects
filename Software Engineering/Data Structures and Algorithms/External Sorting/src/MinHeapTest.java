...
public class MinHeapTest extends TestCase {
    ...
    public void testMinHeap() {
        ...
        byte[] y = h.toByteArray(19, 3);
        byte[] y2 = h.toByteArray(11, 8);
        ...
        double val = h.convert(myHeap.getData(0));
        assertEquals((int)val, 3);
    }
    ...
    public void testHeapSize() {
        ...
        byte[] byteArr = m.toByteArray(19, 3);
        byte[] byteArr2 = m.toByteArray(11, 5);
        byte[] record = new byte[32];
    ...
    public void testCompareRecords() {
        MinHeap m = new MinHeap();
        byte[] b = m.toByteArray(19, 3);
        byte[] b2 = m.toByteArray(11, 5);
        byte[] record = new byte[32];
        System.arraycopy(b, 0, record, 0, 16);
        System.arraycopy(b2, 0, record, 16, 16);
        MinHeap myHeap = new MinHeap(record, 2, 4096);
        assertEquals(myHeap.compareData(b, b2), -1);
    }
    ...
    public void testSiftdown() {
        ...
        System.arraycopy(b5, 0, record, 64, 16);
        MinHeap myHeap = new MinHeap(record, 5, 4096);
        assertTrue(Arrays.equals(myHeap.getData(0), m.toByteArray(15, 2)));
        assertTrue(Arrays.equals(myHeap.getData(16), m.toByteArray(18, 3)));
    }
    ...
    public void testRemovemin() {
        ...
        System.arraycopy(b5, 0, record, 64, 16);
        MinHeap myHeap = new MinHeap(record, 5, 4096);
        assertTrue(Arrays.equals(myHeap.getData(0), m.toByteArray(15, 4)));
        myHeap.removemin();
        assertTrue(Arrays.equals(myHeap.getData(0), m.toByteArray(15, 5)));
        myHeap.removemin();
        assertTrue(Arrays.equals(myHeap.getData(0), m.toByteArray(18, 6)));
        myHeap.removemin();
        assertTrue(Arrays.equals(myHeap.getData(0), m.toByteArray(15, 7)));
        myHeap.removemin();
        assertTrue(Arrays.equals(myHeap.getData(0), m.toByteArray(18, 8)));
        ...
        assertTrue(Arrays.equals(h.getData(0), m.toByteArray(15, 4)));
        byte[] t1 = m.toByteArray(15, 2);
        h.removemin(t1);
        assertTrue(Arrays.equals(h.getData(0), m.toByteArray(15, 5)));
        h.removemin(t1);
        assertTrue(Arrays.equals(h.getData(0), m.toByteArray(18, 6)));
        h.removemin(t1);
        assertTrue(Arrays.equals(h.getData(0), m.toByteArray(15, 7)));
        h.removemin(t1);
        assertTrue(Arrays.equals(h.getData(0), m.toByteArray(18, 8)));
    }
