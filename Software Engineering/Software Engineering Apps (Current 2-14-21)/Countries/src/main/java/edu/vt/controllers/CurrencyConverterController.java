...
public class CurrencyConverterController implements Serializable {
    ...
    public HashMap<String, String> getCurrencyName_currencyId() {
        return currencyName_currencyId;
    }

    public void setCurrencyName_currencyId(HashMap<String, String> currencyName_currencyId) {
        this.currencyName_currencyId = currencyName_currencyId;
    }
    ...
    public CurrencyConverterController() {
         ...
         */
        String apiUrl = "https://free.currconv.com/api/v7/currencies?apiKey=7a8c1e6e11621f6d593c";
        ...
        try {
             ...
             */
            List<String> currencyNamesCaseSensitive = currencyNamesWithDuplicates.stream().distinct().collect(Collectors.toList());

            // Sort the list in alphabetical order
            Collections.sort(currencyNamesCaseSensitive);
    ...
    public void convertCurrency() {
        ...
        String apiUrl = "https://free.currencyconverterapi.com/api/v5/convert?q=" + conversionQuery + "&compact=ultra&apiKey=7a8c1e6e11621f6d593c";
        ...
        try {
            ...
            if (conversionRate.equals(0.0)) {
                ...
                String conversionResultString = String.format("%.2f", result);
