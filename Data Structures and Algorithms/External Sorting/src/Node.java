...
public class Node {
     ...
     * 
     * @param block
     *            the block the merge node corresponds to
     * @param arr
     *            the record value pulled from the block
     * @param cur
     *            the current place in the block
     * @param end
     *            the end of the data in that block
     */
    Node(int block, byte[] arr, int cur, int end) {
        blockNumber = block;
     ...
     * 
     * @param block
     *            the block number to set this block to
     */
     ...
     * 
     * @param cur
     *            the location to set the node to
     */
     ...
     * 
     * @param start
     *            the position to start the node at
     */
     ...
     * 
     * @param end
     *            the ending position value to set the node to
     */
     ...
     * 
     * @param inc
     *            the value to increment the node by
     */
